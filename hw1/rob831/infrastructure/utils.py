...
def sample_trajectory(env, policy, max_path_length, render=False, render_mode=('rgb_array')):
    ...
    while True:
        ...
        ac = ac[0] # decrease dimensionality
        # PREVIOUS MISTAKE that hides the true error: ac = np.clip(ac, env.action_space.low, env.action_space.high)
        ...
        # PREVIOUS MISTAKE: rollout_done = step == max_path_length - 1
...
def sample_trajectories(env, policy, min_timesteps_per_batch, max_path_length, render=False, render_mode=('rgb_array')):
    ...
    while timesteps_this_batch < min_timesteps_per_batch:
        tmp_path = sample_trajectory(env, policy, max_path_length, render, render_mode)
        paths.append(tmp_path)
        timesteps_this_batch += get_pathlength(tmp_path)
