...
\textbf{Collaborators:} \texttt{ssaha3, ag6}\\ 
...
% TODO
\centering
\includegraphics[height=8cm,width=\linewidth]{Images/q1_deliverable.png}
As shown in the figure above, the Double DQN shows characteristically comparable performance with less of an overestimation problem in estimating the returns.
\end{answer}
...
% TODO
\centering
\includegraphics[height=8cm, width=\linewidth]{Images/q2_deliverable.png}
\end{answer}
...
% TODO
\centering
\includegraphics[height=8cm, width=\linewidth]{Images/q3_deliverable.png}
\end{answer}
